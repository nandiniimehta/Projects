...
<body>
	...
	<div class="sidemenu" id="sidebarleftmenu" style="margin-top: -20px; width: 250px;">
		<ul class="sidemenulist">
			...
			<!-- <li><a href="Skill Learn/admin/admin_panel.php">courses</a></li> -->
			...
			<li><a href="" data-toggle="modal" data-target="#myModalupdate">Update course</a></li>
...
<form method="POST" enctype="multipart/form-data" action=" ">
							<div class="form-group">
								...
								Language Name  :
								<input type="text" name="languagename" value="" class="form-control" style="margin-left: 35px;">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
		...
		<!-- Update course Modal Starts -->

		<div class="modal fade" id="myModalupdate" style="size: 50px;">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <!-- Modal body -->
      <div class="modal-body">
      	<form  method="POST" action="update_course.php?update_id">
      	Enter course name :
       <input type="text" name="updatecourse">
