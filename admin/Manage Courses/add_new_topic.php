...
<!-- sidebar starts -->
        ...
        <div class="col-sm-2 col-md-2 sidebar badge-dark" style="margin:inherit;" id="sidebar" >
         <ul class="list-group text-white sidebar-list">
            ...
            <li class="list-group-item bg-dark"><a href="alist.php">Manage Users</a></li>
            <li class="list-group-item bg-dark"><a href="adminlogout.php">Logout</a></li>
 ...
 <!-- ===============================================================================================================-->
            ...
            <form  method="POST" action="verify/verify_changes.php" class="ml-3" onsubmit="return validation()">
                  <!-- <input type="hidden" name="id" value="<php echo $_GET['language_name']; ?>"> -->
