...
<style type="text/css">
  ...
  <a class="navbar-brand text-white" href="#">Skill Learn</a>
      ...
      <div class="row">
        <div class="col-sm-2 col-md-2 sidebar badge-dark" style="margin:inherit;" id="sidebar" >
         <ul class="list-group text-white sidebar-list">
            ...
            <li class="list-group-item bg-dark "><a href="Manage Courses/manage_courses.php">Manage Courses</a></li>
            <li class="list-group-item bg-dark"><a href="Manage Quiz/manage_quiz.php">Manage Quiz</a></li>
            <li class="list-group-item bg-dark"><a href="FAQs/manage_faqs.php">Manage FAQs</a></li>
            <li class="list-group-item bg-dark"><a href="Manage Users/alist.php">Manage Users</a></li>
            <li class="list-group-item bg-dark"><a href="Manage Feedback/manage_feedback.php">Manage Feedback</a></li>
        ...
        <div class=" col-md-10">
          ...
          <div class="col-md-4 mt-3 ml-5">
            <div class="card shadow " style="width: 18rem; box-shadow: 1px 1px 1px 1px #e1dbdb; border-radius:0px; border-top-left-radius: 0px; cursor:pointer;">
              ...
              <div class="card-body">
                <p class="card-text"><a href="Manage Courses/manage_courses.php" style="text-decoration: none;">MANAGE YOUR COURSE <i class="fa fa-book ml-3"></i></a></p>
              </div>
            </div>
