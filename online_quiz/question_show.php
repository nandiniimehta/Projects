...
<body >        <!--   when body load ,timeout functionwill called automatically-->
...
<?php 
 ...
 <table class="table table-hover table-bordered table-active">
  ...
  <tbody>
    ...
    <tr>
      <input type="hidden"  name="<?php echo $quest['id']; ?>"/>&emsp;
    </tr>
	<?php } ?>
  	<?php if (isset($quest['opt1'])){ ?>    
    <tr>
      <td scope="row" ><input type="radio" value="1" name="<?php echo $quest['id']; ?>"/>&emsp;<?php echo $quest['opt1']; ?></td>
    </tr>
	<?php } ?>
	<?php if (isset($quest['opt2'])){ ?>
      <tr>
      <td scope="row"><input type="radio" value="2" name="<?php echo $quest['id']; ?>"/>&emsp;<?php echo $quest['opt2']; ?></td>
    </tr>
    <?php } ?>
    <?php if (isset($quest['opt3'])){ ?>
    <tr>
      <td scope="row"><input type="radio" value="3" name="<?php echo $quest['id']; ?>"/>&emsp;<?php echo $quest['opt3']; ?></td>
    </tr>
    <?php } ?>
    <?php if (isset($quest['opt4'])){ ?>
    <tr>
      <td scope="row"><input type="radio" value="4" name="<?php echo $quest['id']; ?>"/>&emsp;<?php echo $quest['opt4']; ?></td>
    </tr>
     <?php } ?>
      <tr>
